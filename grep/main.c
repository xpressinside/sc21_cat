...
void PrintIf(Flags flags, bool showFileName, char *filename, int count, char * line);
void PrintIfMatch(Flags flags, bool showFileName, char *filename, int count, char * line, char len, regmatch_t match);
